                ...
                <!--<view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    ...
                    <picker @change="yonghuChange" :value="yonghuIndex" :range="yonghuOptions" range-key="yonghuName">
                        <view
                                ...
                                class="uni-input">{{ruleForm.yonghuId?ruleForm.yonghuName:"请选择用户id"}}</view>
                    </picker>
                </view>-->
                <!--<view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">问卷（外键）</view>
                    <picker @change="exampaperChange" :value="exampaperIndex" :range="exampaperOptions" range-key="exampaperName">
                        <view
                                :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.exampaperId?ruleForm.exampaperName:"请选择问卷（外键）"}}</view>
                    </picker>
                </view>-->
                <!--<view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">问题id（外键）</view>
                    <picker @change="examquestionChange" :value="examquestionIndex" :range="examquestionOptions" range-key="examquestionName">
                        <view
                                :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.examquestionId?ruleForm.examquestionName:"请选择问题id（外键）"}}</view>
                    </picker>
                </view>-->
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.examredetailsMyanswer" type="text" v-model="ruleForm.examredetailsMyanswer" placeholder="考生作答"></input>
            </view>
...
<script>
    ...
    export default {
        data() {
            ...
            user: {},
            yonghuOptions: [],//用户id
            yonghuIndex : 0,//用户id下标
            exampaperOptions: [],//问卷（外键）
            exampaperIndex : 0,//问卷（外键）下标
            examquestionOptions: [],//问题id（外键）
            examquestionIndex : 0,//问题id（外键）下标
        ...
        async onLoad(options) {
            ...
            let examquestionParams = {
                page: 1,
                limit: 100,
            }
            let examquestionData = await this.$api.page(`examquestion`, examquestionParams);
            this.examquestionOptions = examquestionData.data.list;
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`examrewrongquestion`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.examrewrongquestionId){
                this.ruleForm.examrewrongquestionId = options.examrewrongquestionId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`examrewrongquestion`, this.ruleForm);
                } else {
                    await this.$api.save(`examrewrongquestion`, this.ruleForm);
                }
